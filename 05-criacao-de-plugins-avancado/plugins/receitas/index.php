...
require 'includes/admin/menus.php';
require 'includes/admin/receita_opts_page.php';
...
add_action('admin_menu', 'sr_admin_menus');
...
// Action Hook que vai ser executado quando adicionarmos um widget
